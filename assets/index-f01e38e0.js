 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function gd(e=Iu()){return hd().then(t=>{if(!t)throw X.create("unsupported-browser")},t=>{throw X.create("indexed-db-unsupported")}),Pr(Dr(e),"messaging").getImmediate()}async function md(e,t){return e=Dr(e),xi(e,t)}function bd(e,t){return e=Dr(e),pd(e,t)}dd();const _d=e=>(So("data-v-2b4f67f8"),e=e(),To(),e),yd=_d(()=>J("div",null,[J("a",{href:"https://vitejs.dev",target:"_blank"},[J("img",{src:rl,class:"logo",alt:"Vite logo"})]),J("a",{href:"https://vuejs.org/",target:"_blank"},[J("img",{src:sl,class:"logo vue",alt:"Vue logo"})])],-1)),wd={__name:"App",setup(e){ei({apiKey:"AIzaSyDMf8LGtCOipiic6cSO8m6THwTBUKJUwoA",authDomain:"notification-50717.firebaseapp.com",projectId:"notification-50717",storageBucket:"notification-50717.appspot.com",messagingSenderId:"967435761286",appId:"1:967435761286:web:ba5a4d77f65c4f72d08307"}),navigator.serviceWorker.register("/firebase-messaging-sw.js").then(r=>{firebase.messaging().useServiceWorker(r)});const n=gd();return bd(n,r=>{console.log(1),console.log("Message received. ",r)}),md(n,{vapidKey:"BK7cmnDdPN-pWVfJxxExDhg652h9JFXWxif96vRvOHrKnVbp3Foc5evmKE5AbkkBwDL6Ed_Fd4hvpqq7gfqFgJI"}).then(r=>{r?console.log("Token is:",r):console.log("No registration token available. Request permission to generate one.")}).catch(r=>{console.log("An error occurred while retrieving token. ",r)}),(r,s)=>(jo(),Ho(ue,null,[yd,Re(fl,{msg:"Vite + Vue"})],64))}},Ed=Wo(wd,[["__scopeId","data-v-2b4f67f8"]]);el(Ed).mount("#app");
